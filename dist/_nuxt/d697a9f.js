...
"use strict";
/* harmony import */ var _node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_VideoPlayer_vue_vue_type_style_index_0_id_16a31e33_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(863);
/* harmony import */ var _node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_VideoPlayer_vue_vue_type_style_index_0_id_16a31e33_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_VideoPlayer_vue_vue_type_style_index_0_id_16a31e33_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--13!./components/VideoPlayer.vue?vue&type=template&id=16a31e33&scoped=true

var VideoPlayervue_type_template_id_16a31e33_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticStyle: {
...
// CONCATENATED MODULE: ./components/VideoPlayer.vue?vue&type=template&id=16a31e33&scoped=true
...
var es_reflect_construct = __webpack_require__(316);
...
var possibleConstructorReturn = __webpack_require__(221);
...
var es_array_from = __webpack_require__(84);
...
var es_number_is_nan = __webpack_require__(981);
...
var es_string_pad_start = __webpack_require__(982);
...
var prev10Icon = __webpack_require__(596);
var next10Icon = __webpack_require__(594);
var volumeIcon = __webpack_require__(599);
var volumeDownIcon = __webpack_require__(598);
var volumeOffIcon = __webpack_require__(600);
var settingIcon = __webpack_require__(597);
var episodesIcon = __webpack_require__(593);
var nextIcon = __webpack_require__(595);
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex_esm["b" /* mapActions */])(['SET_AUTOPLAY'])), {}, {
    ...
    setupVastCtaButton: function setupVastCtaButton() {
      ...
      var updateCtaButton = function updateCtaButton(ctaUrl, adClickCallback, adTitle) {
        ...
        console.log('VAST play event - AdTitle:', finalAdTitle, 'VAST Data:', _this4.vastData);
    ...
    setupTextTracks: function setupTextTracks() {
      ...
      if (this.currentAudioLang && this.currentAudioLang.toString().toLowerCase() === 'fa') {
      ...
      } else if (this.currentAudioLang && this.currentAudioLang.toString().toLowerCase() === 'en') {
        ...
        if (faSubtitleIndex !== -1) {
          ...
          for (var _i4 = 0; _i4 < textTracks.length; _i4++) {
            textTracks[_i4].mode = 'disabled';
          }
          this.currentSubtitle = null;
        }
      } else {
        ...
        if (faSubtitleIndex !== -1) {
          ...
          for (var _i5 = 0; _i5 < textTracks.length; _i5++) {
            textTracks[_i5].mode = _i5 === faSubtitleIndex ? 'showing' : 'disabled';
          }
          this.currentSubtitle = faSubtitleIndex;
        } else {
          // no FA subtitle found, honor default flags from tracks
          var found = false;
          for (var _i6 = 0; _i6 < this.tracks.length; _i6++) {
            if (this.tracks[_i6].default) {
              textTracks[_i6].mode = 'showing';
              this.currentSubtitle = _i6;
              found = true;
              break;
            }
          }
          if (!found) {
            // leave all disabled
            for (var _i7 = 0; _i7 < textTracks.length; _i7++) {
              textTracks[_i7].mode = 'disabled';
            }
            this.currentSubtitle = null;
          }
        }
      ...
      if (this.player && this.player.qualityLevels) {
        ...
        if (value === 'auto') {
          ...
          for (var _i8 = 0; _i8 < levels.length; _i8++) {
            var height = levels[_i8].height;
            levels[_i8].enabled = height + 'p' === value;
          }
        }
      }
      this.closeSettingsDrawer();
            ...
            if (audioTracks && audioTracks.length > 0) {
              for (var i = 0; i < audioTracks.length; i++) {
                if (audioTracks[i].enabled) {
                  ...
                  var trackLabel = audioTracks[i].label || audioTracks[i].language || '';
                  ...
                  if (detectedLang && (!_this27.currentAudioLang || _this27.currentAudioLang !== detectedLang)) {
    ...
    buildStreamWithAudio: function buildStreamWithAudio(streamUrl, lang) {
      try {
        ...
        for (var _i1 = 0, _Array$from = Array.from(params.keys()); _i1 < _Array$from.length; _i1++) {
          var key = _Array$from[_i1];
    ...
    getAudioLabelDisplay: function getAudioLabelDisplay() {
      ...
      var found = this.audioOptions.find(function (o) {
        return o.lang === _this28.currentAudioLang;
      });
        ...
        this.player.one('loadedmetadata', function () {
          try {
            if (!isNaN(currentTime) && currentTime > 0) {
              var dur = _this29.player.duration();
              if (!dur || currentTime <= dur) {
                _this29.player.currentTime(currentTime);
              }
            }
          } catch (err) {
    ...
    setupProgressBarPreview: function setupProgressBarPreview() {
      ...
      // Clean up on dispose
      this.player.on('dispose', function () {
        if (_this32.progressBarElement) {
          _this32.progressBarElement.removeEventListener('mouseenter', _this32.handleProgressBarEnter);
          _this32.progressBarElement.removeEventListener('mousemove', _this32.handleProgressBarMove);
          _this32.progressBarElement.removeEventListener('mouseleave', _this32.handleProgressBarLeave);
        }
      });
    },
...
// EXTERNAL MODULE: ./components/VideoPlayer.vue?vue&type=style&index=0&id=16a31e33&prod&scoped=true&lang=css
var VideoPlayervue_type_style_index_0_id_16a31e33_prod_scoped_true_lang_css = __webpack_require__(1000);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  VideoPlayervue_type_template_id_16a31e33_scoped_true_render,
  staticRenderFns,
  false,
  null,
  "16a31e33",
...
var SubscriptionButtonvue_type_style_index_0_id_5e5fcf10_prod_scoped_true_lang_css = __webpack_require__(816);
