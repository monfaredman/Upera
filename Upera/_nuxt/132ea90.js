...
"use strict";
/* harmony import */ var _node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_id_vue_vue_type_style_index_0_id_c895b16c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(882);
/* harmony import */ var _node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_id_vue_vue_type_style_index_0_id_c895b16c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_extract_css_chunks_webpack_plugin_dist_loader_js_ref_4_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_4_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_4_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_string_replace_loader_index_js_ref_13_id_vue_vue_type_style_index_0_id_c895b16c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--3-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/string-replace-loader??ref--13!./pages/episode/show/_id.vue?vue&type=template&id=c895b16c&scoped=true
...
// CONCATENATED MODULE: ./pages/episode/show/_id.vue?vue&type=template&id=c895b16c&scoped=true
...
var VideoPlayer = __webpack_require__(754);
...
/* harmony default export */ var _idvue_type_script_lang_js = ({
  ...
  watch: {
    ...
    startTime: function startTime() {
      var _this = this;
      this._seekApplied = false;
      this._seekRetry = 0;
      this.$nextTick(function () {
        return _this.trySeekToStartTime();
      });
    },
    // if url changes (next episode), reset seek state
  ...
  methods: {
    ...
    showErrorAlert: function showErrorAlert(data) {
      ...
      this.$swal({
        ...
        switch (value) {
          case 'back':
            window.history.length > 2 ? _this2.$router.go(-1) : _this2.$router.push({
              name: 'episode-id',
              params: {
            ...
            break;
          case 'subscribe':
            _this2.$store.dispatch('subscription/SHOW_MODAL', {
              content_type: 'episode',
              content_id: _this2.$route.params.id
            });
            break;
          case 'download':
            _this2.$router.push({
      ...
      return Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              episode_id = _this3.$route.params.id;
              if (episode_id) {
                _context.next = 1;
                break;
              }
            ...
            case 1:
              ref = _this3.$cookiz.get('ref') || ''; // انتخاب API مناسب بر اساس وضعیت guest
              apiUrl = _this3.guest ? "/ghost/get/watch/series" : "/get/watch/series"; // ارسال درخواست (در اینجا از POST استفاده شده است مانند نسخه‌ی قبلی)
              _context.next = 2;
              return _this3.$axios.post(apiUrl, {
            ...
            case 2:
              ...
              if (response.data.status === 'success') {
                ...
                if (data.fullrate_data) {
                  _this3.fullrateData = data.fullrate_data;
                }

                // تنظیم اطلاعات اصلی قسمت
                ep = data.episode[0];
                _this3.episodeTitle = _this3.$i18n.locale === 'fa' && ep.name_fa ? ep.name_fa : ep.name;
                _this3.posterUrl = data.cdn.lg_backdrop + ep.backdrop;
                // فرض بر این است که لینک ویدیو دارای پارامتر nosub است
                _this3.videoUrl = ep.video.includes('?') ? ep.video + '&nosub=1' : ep.video + '?nosub=1';
                _this3.vastUrl = data.vast;
                _this3.startTime = ep.current_time || 0;
                _this3.series_id = ep.series_id || 0;

                // تنظیم زیرنویس‌ها (در صورت موجود بودن)
                if (data.new_subtitle && Array.isArray(data.new_subtitle)) {
                  _this3.tracks = data.new_subtitle.map(function (track, index) {
                    return {
                      kind: 'captions',
                ...
                if (data.suggestion) {
                  _this3.suggestion = data.suggestion;
                  _this3.suggestionBackdrop = data.cdn.md_backdrop + data.suggestion.backdrop;
                }

                // تنظیم لیست فصل‌ها و قسمت‌های هر فصل
                if (data.season && Object.keys(data.season).length) {
                  _this3.season = data.season;
                  _this3.seasonList = Object.keys(data.season);
                  // باز کردن فصلی که این قسمت به آن تعلق دارد
                  _this3.seasonOpened = ep.season_number.toString();
                }
                ...
                // Pre-roll VAST URL from API
                _this3.vastUrl = data.vast || 'http://localhost:8085/api/v1/load/vast/NHw0';

                // Store vastPlacementToken and offsetSeconds for midroll
                _this3.vastPlacementToken = data.vastPlacementToken || 'NHw0';
                _this3.offsetSeconds = data.offsetSeconds || 50;

                // Midroll URL will be constructed in handleDurationReady using actual player duration
                // }
              } else {
                _this3.showErrorAlert(response.data.data);
              }
              _context.next = 4;
              break;
            case 3:
              _context.prev = 3;
              _t = _context["catch"](0);
              _this3.showErrorAlert(_t.response.data);
            case 4:
              _context.prev = 4;
    ...
    handlePlayerReady: function handlePlayerReady(player) {
      var _this4 = this,
        _player$one,
        _player$one2,
        _player$one3,
      ...
      var onMeta = function onMeta() {
        return _this4.trySeekToStartTime();
      };

      // Works for normal html5/vhs
      (_player$one = player.one) === null || _player$one === void 0 || _player$one.call(player, 'loadedmetadata', onMeta);
      (_player$one2 = player.one) === null || _player$one2 === void 0 || _player$one2.call(player, 'canplay', onMeta);

      // If you use contrib-ads, these are even better (if available)
      (_player$one3 = player.one) === null || _player$one3 === void 0 || _player$one3.call(player, 'contentloadedmetadata', onMeta);
      (_player$one4 = player.one) === null || _player$one4 === void 0 || _player$one4.call(player, 'contentcanplay', onMeta);

      // If metadata is already there, seek immediately
      if (player.readyState && player.readyState() >= 1) {
        this.trySeekToStartTime();
      }
    },
    handleDurationReady: function handleDurationReady(duration) {
      // This is called by VideoPlayer once the full duration is available

      // Only construct midroll URL if we have vastPlacementToken and offsetSeconds
      if (this.vastPlacementToken && this.offsetSeconds && (!this.midrollUrl || this.midrollUrl.length === 0)) {
        var sessionId = "session-".concat(Date.now(), "-").concat(Math.random().toString(36).substr(2, 9));
        this.midrollUrl = ["http://localhost:8085/api/v1/load/vast/".concat(this.vastPlacementToken, "/schedule?contentDuration=").concat(Math.floor(duration), "&contentSessionId=").concat(sessionId, "&offsetSeconds=").concat(this.offsetSeconds)];
      } else if (!this.offsetSeconds) {
        console.log('[Episode] No offsetSeconds provided, skipping midroll setup');
      }
    },
    handleTimeUpdate: function handleTimeUpdate(_ref) {
      ...
      if (this.suggestion) {
        ...
        var creditsStart = final_credits > 0 ? final_credits : duration * 0.975;
    ...
    handleAdEnded: function handleAdEnded() {
      this.adActive = false;
      // IMPORTANT: apply seek after preroll finishes
      this.trySeekToStartTime(true);
    },
        ...
        return regeneratorRuntime.wrap(function (_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 2;
              return _this5.$axios.post('/create/report/episode', payload);
            case 2:
              res = _context2.sent;
    ...
    trySeekToStartTime: function trySeekToStartTime() {
      var _this$$refs$episodePl3,
        _this6 = this;
      var fromAdEnd = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var player = this._player || ((_this$$refs$episodePl3 = this.$refs.episodePlayer) === null || _this$$refs$episodePl3 === void 0 ? void 0 : _this$$refs$episodePl3.player);
      if (!player) return;
      if (this._seekApplied) return;
      if (this.adActive && !fromAdEnd) return;
      var t = Number(this.startTime || 0);
      if (!Number.isFinite(t) || t <= 0) return;

      // Safety: if backend sends ms sometimes, auto-fix
      var dur = typeof player.duration === 'function' ? player.duration() : 0;
      if (Number.isFinite(dur) && dur > 0 && t > dur * 3) {
        t = Math.floor(t / 1000);
      }

      // Need duration/metadata before seeking (especially iOS/Safari)
      if (!Number.isFinite(dur) || dur <= 0) {
        // retry a bit until metadata is ready
        if (this._seekRetry++ < 8) {
          clearTimeout(this._seekTimer);
          this._seekTimer = setTimeout(function () {
            return _this6.trySeekToStartTime(fromAdEnd);
          }, 200);
        }
        return;
      }

      // Clamp so we don't seek beyond end
      var safe = Math.max(0, Math.min(t, Math.max(dur - 1, 0)));
      try {
      ...
      // Verify it “stuck”; if not, retry a few times
      var now = typeof player.currentTime === 'function' ? player.currentTime() : 0;
      if (Math.abs(now - safe) < 1.5) {
        this._seekApplied = true;
        this._seekRetry = 0;
      } else if (this._seekRetry++ < 8) {
        clearTimeout(this._seekTimer);
        this._seekTimer = setTimeout(function () {
          return _this6.trySeekToStartTime(fromAdEnd);
        }, 200);
...
// EXTERNAL MODULE: ./pages/episode/show/_id.vue?vue&type=style&index=0&id=c895b16c&prod&scoped=true&lang=css
var _idvue_type_style_index_0_id_c895b16c_prod_scoped_true_lang_css = __webpack_require__(1019);
