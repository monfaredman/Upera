...
var render = function render() {
  ...
  return _c('div', {
    ...
    return _c('div', {
      ...
      attrs: {
        "data-src": item.type === 'genre' ? __webpack_require__(869)("./".concat(item.en, ".png")) : __webpack_require__(869)("./".concat(item.cover, ".png")),
        "alt": item.fa
      }
    }, 'b-img', {
      fluidGrow: true,
...
var genresvue_type_style_index_0_id_10bf9d67_prod_scoped_true_lang_css = __webpack_require__(959);
...
var map = {
	...
	"./Family.png": 604,
	"./Fantasy.png": 605,
	"./Frame 1000003885-7.png": 606,
	"./Frame 1000003885.png": 607,
	"./History.png": 608,
	"./Horror.png": 609,
	"./Learning.png": 610,
	"./Musical.png": 611,
	"./Mystery.png": 612,
	"./Reality_Show.png": 613,
	"./Romance.png": 614,
	"./Sci_Fi.png": 615,
	"./Short.png": 616,
	"./Sport.png": 617,
	...
	"./War.png": 621,
	"./Western.png": 622,
	"./anime-category.png": 623,
	"./cast-category.png": 624,
	"./cast-foreign-category.png": 625,
	"./cast-ir-category.png": 626,
	"./director-category.png": 627,
	"./dubbing-category.png": 628,
	"./oscar-category.png": 629
};
