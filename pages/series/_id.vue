...
export default {
  ...
  async asyncData(context) {
    ...
    await context.app.$axios
      .get('/getV2/series/' + context.params.id)
      .then((result) => {
        res = result
      })
      .catch((e) => {
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            description.substring(0, 160) || `تماشای آنلاین سریال ${title}`,
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: `${title}, سریال ${title}, تماشای آنلاین, ${genres}, ${castList}`,
        },
        // Open Graph
        {
          hid: 'og:title',
        ...
        },
        {
          ...
          content:
            description.substring(0, 200) || `تماشای آنلاین سریال ${title}`,
        },
        {
          hid: 'og:image',
          property: 'og:image',
