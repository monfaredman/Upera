        ...
        <div class="video-content">
          <div class="row">
            ...
            <div class="col-12 col-lg-8 mb-3 mb-lg-0">
              <div id="video-player" class="mb-4">
                <div class="video-wrapper">
                  ...
                  <VideoPlayer
                    ...
                    :poster-url="
                      selectedVideo.image || '/images/default-poster.jpg'
                    "
              ...
              <div v-if="selectedVideo" id="video-detail">
                <div class="video-info pb-1 mb-1 pb-md-4 mb-md-4">
                  ...
                  <div
                    class="d-flex flex-column-reverse flex-md-row align-items-lg-end flex-wrap gap-md-3"
                  >
                    <div
                    ...
                    >
                      <div
                        v-if="video.channel"
                        class="avatar-wrapper align-items-center"
                      >
                        <div class="avatar">
                          <nuxt-link
                            :to="{
                              name: 'channel-channel',
                              params: { channel: video.channel.cat_id },
                            }"
                          >
                            <img
                              :src="
                        ...
                        <div class="avatar-caption text-nowrap">
                          <div
                            class="fw-medium fs-lg-x-large text-gray-700 mb-1"
                          >
                            <nuxt-link
                              :to="{
                                name: 'channel-channel',
                          ...
                          <div
                            class="fw-medium fs-small fs-lg-x-medium text-gray-700"
                          >
                      ...
                      <button
                        v-if="video.channel"
                        class="btn btn-primary btn-sm d-inline-flex d-md-none"
                        @click="toggleFollowChannel(video.channel.id)"
                      >
                        <svg
                          class="ms-1"
                          width="17"
                    ...
                    >
                      ...
                      <div class="d-flex gap-1 gap-md-3">
                        <button
                          ...
                          @click.prevent="modalsharing = !modalsharing"
                        >
                          <svg
                            class="ms-1"
                            width="18"
                        ...
                        <button
                          class="btn btn-light btn-sm"
                          @click.prevent="ADD_WATCHLIST(video.id, 'ugc')"
                        >
                          <svg
                            class="ms-1"
                            width="12"
                            ...
                            fill="none"
                            :class="{
                              'text-primary': video.is_watchlist == 1,
                              'text-gray': !video.is_watchlist,
                            }"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <path
                        ...
                        <button
                          class="btn btn-light btn-sm"
                          @click.prevent="ADD_CLAP(video.id, 'ugc')"
                        >
                          <svg
                            class="ms-1"
                            width="18"
                ...
                <div class="video-caption pb-1 mb-2 mb-md-4">
                  <div class="row mb-3">
                    ...
                    <div class="fs-medium">
                      <span v-if="!isExpanded">
                        {{
                          video.summary.length > maxLength
                            ? video.summary.substring(0, maxLength) + '...'
                            : video.summary
                        }}
                      </span>
                      <span v-else>
                  ...
                  <div
                    class="d-flex align-items-center justify-content-between fs-medium"
                  >
            ...
            <div class="col-12 col-lg-4">
              <div
                v-if="video.playlist_videos.length"
                id="video-playlist"
                class="mb-4"
              >
                <b-card
                  no-body
                  class="card-radius text-bg-gray h-100 border-light"
                >
                  <!-- Card Header -->
                  <b-card-header
                    class="d-flex align-items-center justify-content-between border-bottom-0 bg-transparent"
                  >
                    ...
                    <div class="form-check form-switch">
                      ...
                      />
                      <label class="form-check-label fw-bold" for="playAll"
                        >پخش خودکار</label
                      >
                    </div>
                  </b-card-header>
                    ...
                    <div class="h-100 position-relative">
                      <div class="scrollable">
                        ...
                        >
                          ...
                          <b-col cols="6">
                            <div
                              class="h-100 w-100 d-flex flex-column flex-wrap justify-content-between py-2 py-lg-3"
                            >
                              <nuxt-link
                                :to="{
                                  name: 'video-id',
              ...
              <div v-if="video" id="video-similar">
                <div class="card card-radius text-bg-white h-100 border-0">
                  ...
                  >
                    <div class="card-title">ویديوهای مشابه</div>
                    <div
                      v-if="!video.playlist_videos.length"
                          ...
                          <div class="col-5 col-lg-5">
                            ...
                            >
                              <div class="w-100">
                                ...
                                <div
                                  class="text-gray-700 text-truncate fs-small"
                                >
                                  {{ video_item.summary }}
                                </div>
                              </div>
...
export default {
  ...
  methods: {
    ...
    playNextVideo() {
      let videoList =
        this.video.playlist_videos.length > 0
          ? this.video.playlist_videos
          : this.video.similar_videos
