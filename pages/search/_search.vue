    ...
    <div id="checkcontainer" class="container-fluid">
      ...
      <div>
        <div class="search_main_container_reswidth">
          ...
          <div
            class="input-group search-field with-filter my-4 insert_comment search_box_container d-md-none"
          >
            <b-form-input
              v-model="query"
              autofocus
          ...
          <div class="search_badge">
            <a
              ...
              class="badge badge-pill small font-weight-normal py-2 px-3 mb-2 mr-2 mr-lg-4"
              @click.prevent="
                imdb = !imdb
                IN_SEARCH()
              "
...
export default {
  ...
  async asyncData(context) {
    if (context.params.search) {
      ...
      //  }else{
      res = await context.app.$axios.post(
