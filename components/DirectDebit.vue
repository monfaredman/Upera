        ...
        <div v-if="directdebit_subscriptions.subscribe_fee" class="download-links-items download-links-items-credit">
          <div class="tenor tenor-m">
            <div class="mt-3">
              ...
              <br>
              توجه: <br>1-شما در هر زمانی می توانید گزینه های بالا را فعال یا غیرفعال کنید<br>2-در حالتی که فیلم یا سریال انتخابی شما با روش های پرداخت دیگری خرید شده باشد، خرید مجددی با پرداخت خودکار توسط ما انجام نخواهد شد<br>3-بانک ملی به زودی اضافه می شود
            </div> 
          </div>
        </div>
